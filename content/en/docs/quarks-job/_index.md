...
weight: 50
description: >
  Runs Kubernetes jobs on demand and optionally captures the JSON output into a secret
---

* Backlog: [Pivotal Tracker](https://www.pivotaltracker.com/n/projects/2192232)
* Slack: #quarks-dev on [https://slack.cloudfoundry.org](https://slack.cloudfoundry.org/)
* Docker: https://hub.docker.com/r/cfcontainerization/quarks-job/tags
...
It is possible to configure Quarks Job to watch over different namespaces, [refer to the quarks-operator instructions](../quarks-operator/install/#multiple-namespaces), as they are shared between all the `Quarks` components.
